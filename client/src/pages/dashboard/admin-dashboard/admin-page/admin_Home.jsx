...
import chatbotImage from '../admin-assets/chatbot1.jpg';
...
import Admin_hospitalVideo from '../admin-assets/admin_hospital.mp4';
import Admin_yogaWoman from '../admin-assets/admin_yogawoman.png';
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center pt-24 overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4">
          <div className="mt-[32rem] flex flex-wrap justify-center gap-4 animate-fade-in delay-700">
            <Link to="/admin/admin-Appoint" className="bg-white text-blue-600 hover:bg-blue-600 hover:text-white border border-blue-600 font-semibold px-5 py-2 rounded-full shadow transition">
              Book Appointment
            </Link>
            <Link to="/admin/admin-findhospital" className="bg-white text-blue-600 hover:bg-blue-600 hover:text-white border border-blue-600 font-semibold px-5 py-2 rounded-full shadow transition">
              Find Hospital
            </Link>
            <Link to="/admin/admin-exploreus" className="bg-white text-blue-600 hover:bg-blue-600 hover:text-white border border-blue-600 font-semibold px-5 py-2 rounded-full shadow transition">
              Explore Us
            </Link>
            <Link to="/admin/admin-contact" className="bg-white text-blue-600 hover:bg-blue-600 hover:text-white border border-blue-600 font-semibold px-5 py-2 rounded-full shadow transition">
              Contact
            </Link>
          </div>
        </div>
