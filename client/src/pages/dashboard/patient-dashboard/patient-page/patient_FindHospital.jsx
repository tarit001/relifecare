...
const hospitals = [
  {
    ...
    directions: '#',
    website: '#',
    image: require('../patient-assets/hospital images/hospital.png'),
  },
  {
    ...
    directions: '#',
    website: '#',
    image: require('../patient-assets/hospital images/hospital1.png'),
  },
  {
    ...
    directions: '#',
    website: '#',
    image: require('../patient-assets/hospital images/hospital11.png'),
  },
];

const Patient_FindHospital = () => {
  return (
...
export default Patient_FindHospital;
