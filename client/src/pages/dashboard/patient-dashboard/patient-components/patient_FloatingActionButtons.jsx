...
const Patient_FloatingActionButtons = () => {
  const [show, setShow] = useState(false);
  const location = useLocation();
  const isHomePage = location.pathname === "/patient/patient-home";
...
export default Patient_FloatingActionButtons;
