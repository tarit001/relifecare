...
const hospitals = [
  {
    ...
    directions: '#',
    website: '#',
    image: require('../doctor-assets/hospital images/hospital.png'),
  },
  {
    ...
    directions: '#',
    website: '#',
    image: require('../doctor-assets/hospital images/hospital1.png'),
  },
  {
    ...
    directions: '#',
    website: '#',
    image: require('../doctor-assets/hospital images/hospital11.png'),
  },
];

const Doctor_FindHospital = () => {
  return (
...
export default Doctor_FindHospital;
