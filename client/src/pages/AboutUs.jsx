...
export default function AboutUsPage() {
  return (
    <div className="bg-gradient-to-r from-blue-300 via-slate-300 to-gray-400 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300 min-h-screen">
      {/* About Us Header & Content */}
      <section className="max-w-7xl mx-auto py-16 px-6">
        <h1 className="text-3xl font-bold text-blue-700 dark:border-gray-700 mb-6">About Us</h1>
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* Sidebar */}
          <aside className="bg-white dark:bg-gray-800 p-6 rounded shadow-sm text-sm border border-gray-200 dark:border-gray-700">
      ...
      {/* Info Cards */}
      <section className="max-w-7xl mx-auto px-6 pb-20 grid md:grid-cols-3 lg:grid-cols-2 gap-8">
        {[
          {
          ...
          <div
            key={i}
            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-sm overflow-hidden hover:shadow-md transition"
          >
            ...
            <div className="p-5">
              ...
              <a href="#" className="text-blue-700 dark:text-blue-400 text-sm font-semibold hover:underline">
                {item.link}
              </a>
            </div>
          </div>
      ...
      {/* Footer Section with Separate Dark Background */}
      <div className="bg-gray-200 dark:bg-gray-950 transition-colors duration-300">
        <Footer />
      </div>
